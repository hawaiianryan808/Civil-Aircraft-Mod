...
--[[
    ...
    Ny_max      		= 2.0,	-- [G]
    Ny_max_e   			= 2.5,	-- [G]
    bank_angle_max      = 30,   -- Modern flight computers allow slightly more aggressive banking
    ...
    engines_nozzles = 
    {
        ...
        {
            pos =   {-4.2,	-2.96,	-21.121},
            elevation			=  -2.0,	-- 2 degree exhaust depression (negative means thrust causes nose to pitch down)
			azimuth             = 	2.5,	-- 2.5 degree toe-in (positive means thrust vector points toward longitudinal axis; exhaust points away)
            diameter    		=   0.755,
            exhaust_length_ab   =   9,
        ...
        [4] = 	-- Right outboard
        {
            pos =   {-4.2,	-2.96,	21.121},
            elevation			=  -2.0,	-- 2 degree exhaust depression (negative means thrust causes nose to pitch down)
			azimuth             =  -2.5,	-- 2.5 degree toe-in (negative means thrust vector points toward longitudinal axis; exhaust points away)
            diameter    		=   0.755,
            exhaust_length_ab   =   9,
            exhaust_length_ab_K =   0.76,
            smokiness_level     =   0.01,
    ...
    SFM_Data = {
        aerodynamics = 
        {
            ...
            cy_flap     = 1.00,     -- Flap lift
            cx_brk      = 0.12,     -- Speedbrake drag (estimated)
            ...
            table_data = 
            {
				...
				[6]  = {0.8,   0.024,  0.091,  0.046,    0.03,    0.50,   14.0,   1.05},
...
[4] = {0.9,  0.10, 	  0.015,   0.85, 	5.0, 	0.9, 	0.1, 	-0.05,	-0.02, 	1.5, 	0.04, 	0.20, 	-0.04, 	0.2, 	0.5},
        ...
        engine = 
        {
            ...
            -- Thrust lapse for high-bypass turbofans like CF6 (~30–40% of
			-- SL thrust at 10–12 km).
            dpdh_m  = 19000,	-- [N/km per engine]
            dpdh_f  = 19000,
